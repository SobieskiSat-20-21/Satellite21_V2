...
//BMP top layer parameters
#define BMP280_TOP_SDO_STATE 0 // pull state on SDO pin
#define BMP280_TOP_I2C_ADDRESS ((0x76 | BMP280_TOP_SDO_STATE) << 1)
//BMP bottom parameters
#define BMP280_BTM_SDO_STATE 1 // pull state on SDO pin
#define BMP280_BTM_I2C_ADDRESS ((0x76 | BMP280_BTM_SDO_STATE) << 1)
// Register adresses
...
// declaration of a deafault configuration struct
